...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://Arcadiusz.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("arek94@onet.com.pl");
        driverTrello.findElement(By.id("password")).sendKeys("Sn@kes240AS");
